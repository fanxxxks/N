"""Factor inventory audit measurement run (team task t2, 2026-08-31).

RESEARCH DIAGNOSTIC -- not promotion evidence.  Measures the existing 62-feature
...
def main() -> int:
    ...
    assert n_f == len(FEATURE_NAMES) == 62, f"expected 62 features, got {n_f}"
    ...
    provenance.update({
        ...
        "manifest_note": "manifest rebuild pending (t1 blocker); id computed read-only",
