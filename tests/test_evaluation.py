...
def test_cli_smoke(tmp_path, populated_db: DataConfig, production_gate_asof):
    import yaml

    # t23: in-process formal entry — the G8 evaluation day is injected
    # through the p16-reserved seam (production_gate_asof), so the
    # historical 2024 fixture axis stays deterministic (no wall clock).
...
def test_cli_confirmation_smoke(
